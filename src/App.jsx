...
function App() {
  ...
  useEffect(() => {
    async function fetchGames() {
      try {
        const res = await fetch("https://playradarhub-backend-54816317792.us-central1.run.app/api/next_week_release");
  ...
  return (
      <ThemeProvider>
          <Router>
            ...
            </div><Sidebar expanded={sidebarOpen} onToggle={() => setSidebarOpen((open) => !open)} />
